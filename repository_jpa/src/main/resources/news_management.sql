...
ALTER TABLE news_management.author ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME news_management.author_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY news_management.author   ADD CONSTRAINT author_pk PRIMARY KEY (id);
...
ALTER TABLE ONLY news_management.news   ADD CONSTRAINT news_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY news_management.roles   ADD CONSTRAINT roles_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY news_management.tag   ADD CONSTRAINT tag_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY news_management."user"   ADD CONSTRAINT user_pkey PRIMARY KEY (id);
